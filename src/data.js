...
export const PROJECTS = [
  {
    ...
    pinned: [
      'One search box over every department’s data',
      'A quality score, so trust is a number not a rumour',
      'Lineage as a graph you can read, not a research task',
    ],
    sections: 'portal',
  },
  {
    ...
    pinned: [
      'It asks what you meant before it answers',
      'Debug mode shows the SQL and the assumptions',
      'Usage data became the platform team’s research',
    ],
    sections: 'agent',
  },
  {
    ...
    stack: ['figma', 'figma-make', 'angular', 'typescript', 'aws', 'neptune', 'dynamodb'],
    pinned: [
      'Give it a view name, it fills in every column and type',
      'It fails loudly, before a human is asked to approve',
      'Approvers read a diff instead of a document',
    ],
    sections: 'ingestion',
  },
  {
    ...
    stack: ['figma', 'figma-make', 'angular', 'typescript', 'aws', 'neptune', 'dynamodb'],
    pinned: [
      'Built in sessions with the stewards who own the words',
      'Typed links with cardinality, so the model is checkable',
      'The vocabulary the agent reasons over',
    ],
    sections: 'cdm',
  },
  {
    ...
    pinned: [
      'Pivoted from corporate LMS to mental health mid-project',
      'Dual interface: therapists assign, patients follow',
      'Eight months, six people, research re-earned twice',
    ],
    year: '2025',
  ...
  },
  {
    ...
    stack: ['figma', 'miro', 'design-system', 'prototype'],
    pinned: [
      'Built for a catalogue going from 5 to 25 integrations',
      'Visualise, control and secure every connection',
      'Ten weeks, as a UX design intern',
    ],
    year: '2023',
  ...
  },
  {
    ...
    pinned: [
      'Navigation projected onto the visor, not a phone',
      'Riders need information where looking costs nothing',
      'Field of view tested on a physical rig',
    ],
    year: '2022',
  ...
  },
  {
    ...
    pinned: [
      'One app, two devices: the child’s and the parent’s',
      'Rewards a parent can bend do not hold',
